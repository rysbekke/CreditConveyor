<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptProfferAgro.aspx.cs" Inherits="СreditСonveyor.Microcredit.rptProfferAgro" %>
...
<table class="line">
   <tr>
    ...
    <tr>
        <td>Вид кредита:</td>
        <td>Потребительский кредит "Замат"</td>
        <td></td>
    </tr>
    <tr>
        <td>Сумма кредита:</td>
