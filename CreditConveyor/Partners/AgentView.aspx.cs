...
namespace Zamat.Microcredit
{
    public partial class AgentView : System.Web.UI.Page
    {
        ...
        public void check_security()
        {
            ...
            string pageName = file[file.Length - 1];
            GeneralController gtx = new GeneralController();
            if (gtx.check_security_page(UserName, pageName) == false) Response.Redirect("/Account/Login");
        }
        ...
        public void refreshGrid()
        {
            ...
            List<Request> lst;
            if (rle == 5) { lst = ItemController.GetRequestsAllForExpert(usrID, agentRoleID, nRequest, inn, creditID, surname, name, dt1, dt2, connectionStringR, chkbxlistStatus.Items[0].Selected, chkbxlistStatus.Items[1].Selected, chkbxlistStatus.Items[2].Selected, chkbxlistStatus.Items[3].Selected, chkbxlistStatus.Items[4].Selected, chkbxlistStatus.Items[5].Selected, chkbxlistStatus.Items[6].Selected, chkbxlistStatus.Items[7].Selected, chkbxlistStatus.Items[8].Selected, chkbxlistStatus.Items[9].Selected, chkbxlistStatus.Items[10].Selected, chkbxlistStatus.Items[11].Selected, chkbxlistStatus.Items[12].Selected, chkbxlistKindActivity.Items[0].Selected, chkbxlistKindActivity.Items[1].Selected, chkbxlistKindActivity.Items[2].Selected, chkbxGroup.Items[0].Selected, chkbxGroup.Items[1].Selected, gvRequests.PageIndex, gvRequests.PageSize, chkbxOffice.Items[0].Selected, chkbxOffice.Items[1].Selected, chkbxOffice.Items[2].Selected, chkbxOffice.Items[3].Selected, chkbxOffice.Items[4].Selected, chkbxOffice.Items[5].Selected, chkbxOffice.Items[6].Selected, chkbxOffice.Items[7].Selected, chkbxOffice.Items[8].Selected, chkbxOffice.Items[9].Selected); } //Эсперты ГБ Доскредо
            else if (rle == 2) { lst = ItemController.GetRequestsForExpert(usrID, agentRoleID, nRequest, inn, creditID, surname, name, dt1, dt2, connectionStringR, chkbxlistStatus.Items[0].Selected, chkbxlistStatus.Items[1].Selected, chkbxlistStatus.Items[2].Selected, chkbxlistStatus.Items[3].Selected, chkbxlistStatus.Items[4].Selected, chkbxlistStatus.Items[5].Selected, chkbxlistStatus.Items[6].Selected, chkbxlistStatus.Items[7].Selected, chkbxlistStatus.Items[8].Selected, chkbxlistStatus.Items[9].Selected, chkbxlistStatus.Items[10].Selected, chkbxlistStatus.Items[11].Selected, chkbxlistStatus.Items[12].Selected, chkbxlistKindActivity.Items[0].Selected, chkbxlistKindActivity.Items[1].Selected, chkbxlistKindActivity.Items[2].Selected, chkbxGroup.Items[0].Selected, chkbxGroup.Items[1].Selected, gvRequests.PageIndex, gvRequests.PageSize, chkbxOffice.Items[0].Selected, chkbxOffice.Items[1].Selected, chkbxOffice.Items[2].Selected, chkbxOffice.Items[3].Selected, chkbxOffice.Items[4].Selected, chkbxOffice.Items[5].Selected, chkbxOffice.Items[6].Selected, chkbxOffice.Items[7].Selected, chkbxOffice.Items[8].Selected, chkbxOffice.Items[9].Selected); } //Эксперты филиала Доскредо
            else if (rle == 9) { lst = ItemController.GetRequestsAllForAdmin(usrID, agentRoleID, orgID, nRequest, inn, creditID, surname, name, dt1, dt2, connectionStringR, chkbxlistStatus.Items[0].Selected, chkbxlistStatus.Items[1].Selected, chkbxlistStatus.Items[2].Selected, chkbxlistStatus.Items[3].Selected, chkbxlistStatus.Items[4].Selected, chkbxlistStatus.Items[5].Selected, chkbxlistStatus.Items[6].Selected, chkbxlistStatus.Items[7].Selected, chkbxlistStatus.Items[8].Selected, chkbxlistStatus.Items[9].Selected, chkbxlistStatus.Items[10].Selected, chkbxlistStatus.Items[11].Selected, chkbxlistStatus.Items[12].Selected, chkbxlistKindActivity.Items[0].Selected, chkbxlistKindActivity.Items[1].Selected, chkbxlistKindActivity.Items[2].Selected, chkbxGroup.Items[0].Selected, chkbxGroup.Items[1].Selected, gvRequests.PageIndex, gvRequests.PageSize, chkbxOffice.Items[0].Selected, chkbxOffice.Items[1].Selected, chkbxOffice.Items[2].Selected, chkbxOffice.Items[3].Selected, chkbxOffice.Items[4].Selected, chkbxOffice.Items[5].Selected, chkbxOffice.Items[6].Selected, chkbxOffice.Items[7].Selected, chkbxOffice.Items[8].Selected, chkbxOffice.Items[9].Selected); } //Админы Билайн
            else { lst = ItemController.GetRequestsForAgent(usrID, agentRoleID, nRequest, inn, creditID, surname, name, dt1, dt2, connectionStringR, groupID, chkbxlistStatus.Items[0].Selected, chkbxlistStatus.Items[1].Selected, chkbxlistStatus.Items[2].Selected, chkbxlistStatus.Items[3].Selected, chkbxlistStatus.Items[4].Selected, chkbxlistStatus.Items[5].Selected, chkbxlistStatus.Items[6].Selected, chkbxlistStatus.Items[7].Selected, chkbxlistStatus.Items[8].Selected, chkbxlistStatus.Items[9].Selected, chkbxlistStatus.Items[10].Selected, chkbxlistStatus.Items[11].Selected, chkbxlistStatus.Items[12].Selected, chkbxlistKindActivity.Items[0].Selected, chkbxlistKindActivity.Items[1].Selected, chkbxlistKindActivity.Items[2].Selected, chkbxGroup.Items[0].Selected, chkbxGroup.Items[1].Selected, gvRequests.PageIndex, gvRequests.PageSize, chkbxOffice.Items[0].Selected, chkbxOffice.Items[1].Selected, chkbxOffice.Items[2].Selected, chkbxOffice.Items[3].Selected, chkbxOffice.Items[4].Selected, chkbxOffice.Items[5].Selected, chkbxOffice.Items[6].Selected, chkbxOffice.Items[7].Selected, chkbxOffice.Items[8].Selected, chkbxOffice.Items[9].Selected); } //Агенты Билайн
            if (lst.Count > 0)
            {
        ...
        protected void btnSendCreditRequest_Click(object sender, EventArgs e)
        {
                ...
                (chkbxTypeOfCollateral.Items[2].Selected == true))
            {
                ...
                if ((hfCustomerID.Value != "noselect" && Page.IsValid)) //условие для поруч
                {
                    ...
                    if ((chkbxTypeOfCollateral.Items[2].Selected == true) && (hfGuarantorID.Value == "noselect")) b = 3;
        ...
        protected void AddRequest()
        {
            ...
            if (hfRequestAction.Value == "new")
            {
                ...
                decimal commision = 0; string NameOfCredit = "Замат";
                //int prodID = 1152; //замат
        ...
        public void hideDcbService()
        {
            ...
            btnAnimals.Visible = false; //Ветинспекция
            ...
            try
            {
                ...
                if (lst.RequestStatus == "Новая заявка")
                {
                    ...
                    if (Convert.ToInt32(Session["RoleID"]) == 2)
                    {
                        ...
                        btnAnimals.Visible = true; //Ветинспекция
    ...
    "Вам одобрен кредит в размере " + req.RequestSumm.ToString() + " сом на " + req.RequestPeriod + " месяцев под " + req.RequestRate + " % годовых.Ежемесячный платеж в размере " + paysum.ToString() + " сом по " + payday.ToString() + " - ым числам.Credit ID для погашения " + req.CreditID.ToString() + ". ";
        ...
        protected void btnShowSMS_Click(object sender, EventArgs e)
        {
            ...
            if (strtxt != "0")
            {
                ...
                lblSMS.Text = "Номер клиента:" + cust.ContactPhone1 + ", Текст СМС:" + strtxt;
            } 
            else
            {
                //lblSMS.Text = "График не построен"; 
        ...
        {
            getDocFromServDCB("Вет инспекция");
