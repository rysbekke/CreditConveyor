<%@ Page Title="МК кредиты" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Loans.aspx.cs" Inherits="СreditСonveyor.Partners.Loans" Debug="true" Async="true" AsyncTimeout="60" %>
...
<asp:Panel ID="pnlUser" runat="server">
	...
	<div class="clear chkbxhead"><p style="text-align:center"><b><a class="params" href="#params">Параметры</a></b></p></div>
        <div class="divparams">		
				
                <div class="search"><p>№ заявки</p><asp:TextBox ID="tbRequestID" runat="server" class="form-control" TextMode="Number" AutoCompleteType="Disabled"></asp:TextBox>&nbsp;</div>
				<div class="search"><p>ИНН</p><asp:TextBox ID="tbSearchRequestINN" runat="server" class="form-control" TextMode="Number" AutoCompleteType="Disabled"></asp:TextBox><asp:RegularExpressionValidator ID="rfedentificationNumber" runat="server" ErrorMessage="Ошибка!" ValidationGroup="SaveCustomers"  ControlToValidate="tbSearchRequestINN" ValidationExpression="\d\d\d\d\d\d\d\d\d\d\d\d\d\d"></asp:RegularExpressionValidator>&nbsp;</div>
                <div class="search"><p>CreditID</p><asp:TextBox ID="tbCreditID" runat="server" class="form-control" TextMode="Number" AutoCompleteType="Disabled"></asp:TextBox>&nbsp;</div>
				<div class="search"><p>Фамилия</p><asp:TextBox ID="tbSearchRequestSurname" runat="server" class="form-control" AutoCompleteType="Disabled"></asp:TextBox>&nbsp;</div>
				<div class="search"><p>Имя</p><asp:TextBox ID="tbSearchRequestName" runat="server" class="form-control" AutoCompleteType="Disabled"></asp:TextBox>&nbsp;</div>
       </div>	    
                <div class="search"><p>Дата</p><asp:TextBox ID="tbDate1b" runat="server" ClientIDMode="Static" class="form-control" AutoCompleteType="Disabled" TextMode="Date" Width="170px"></asp:TextBox>&nbsp;</div>
				<div class="search"><p>&nbsp</p><asp:TextBox ID="tbDate2b" runat="server" ClientIDMode="Static" Visible="False" class="form-control" AutoCompleteType="Disabled" TextMode="Date" Width="170px"></asp:TextBox>&nbsp;</div>
        ...
        <div class="clear chkbxhead"><p style="text-align:center"><b><a class="filters" href="#filters">Фильтр</a></b></p></div>
        <div class="divfilters">
        <div>
    
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                        <div class="clear chkbxhead"><p style="text-align:center"><b>Статусы</b></p></div>
      ...
      <%--      <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                <ContentTemplate>--%>
                <div class="left"><asp:CheckBox ID="chkbxGroup1" runat="server" Text="КапиталБанк" Visible="false" Checked="true"/></div>
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Выбрать">
                                <ItemTemplate>
                                    ...
                                    <a href='/Partners/Loan?RequestID=<%# Eval("RequestID") %>' >Выбрать</a>
                                </ItemTemplate>
                            </asp:TemplateField>
