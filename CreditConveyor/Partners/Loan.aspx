<%@ Page Title="МК кредиты" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Loan.aspx.cs" Inherits="СreditСonveyor.Partners.Loan" Debug="true" Async="true" AsyncTimeout="60" %>
...
<asp:Panel ID="pnlUser" runat="server">
    ...
    <a href="/Partners/Loans">Назад</a>
		...
		<asp:Panel ID="pnlNewRequest" runat="server" Visible="false" BackColor="#E3DAE8" >
...
<div>
  <!-- Nav tabs -->
   ...
   <ul class="tabs nav nav-tabs">
      ...
      <li><a href="#tabmain" data-tab='tabmain' class="active selected"><b>Данные</b></a></li>
                      ...
                      <div>
                        ...
                        <div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel8" runat="server"><ContentTemplate>
                             <asp:TextBox ID="TbAmountOfDownPayment" runat="server" OnTextChanged="TbAmountOfDownPayment_TextChanged" AutoPostBack="True"></asp:TextBox>
...
<%--                              <asp:TextBox ID="TbAmountOfDownPayment" runat="server" AutoPostBack="true" OnTextChanged="TbAmountOfDownPayment_TextChanged" Text="0,00" onchange="demo.TbAmountOfDownPayment()" ClientIDMode="Static"></asp:TextBox>--%>
                        ...
                        <div>
                            ...
                            <asp:TextBox ID="RadNumTbRequestSumm" runat="server" class="form-control" Type="Currency" MinValue="0" Enabled="true" onchange="demo.valueChanged3()" TabIndex="15" ReadOnly="true" ClientIDMode="Static"></asp:TextBox>
        ...
        <div class="row">
            <div class="col-md-8 col-xs-12 panels">
                    ...
                    <asp:GridView ID="gvProducts" runat="server" AutoGenerateColumns="False" CssClass="gvProducts" OnRowCommand="gvProducts_RowCommand" ShowHeader="true" ShowFooter = "true" onrowediting="gvProducts_RowEditing" OnRowCancelingEdit="gvProducts_RowCancelingEdit" OnRowUpdating="gvProducts_RowUpdating" DataKeyNames="ProductID">
										<Columns>
											...
											<asp:TemplateField  HeaderText = "Наименование" ItemStyle-Width="200px" HeaderStyle-Width="200px">
											...
											<asp:TemplateField  HeaderText = "СерийныйN" ItemStyle-Width="200px" HeaderStyle-Width="200px">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText = "imei____код" ItemStyle-Width="200px" HeaderStyle-Width="200px">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText = "Цена" ItemStyle-Width="150px" HeaderStyle-Width="150px">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText = "Примечание" ItemStyle-Width="200px" HeaderStyle-Width="200px">
                                                <ItemTemplate>
                                          ...
                                          <asp:TemplateField HeaderText = "Итого" ItemStyle-Width="100px" HeaderStyle-Width="100px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPriceWithTarif" runat="server" Text='<%# Eval("PriceWithTarif")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

											<asp:TemplateField HeaderText="Операции" ItemStyle-Width="200px" HeaderStyle-Width="200px">
												<ItemTemplate>
                                            ...
                                            <asp:CommandField  ShowEditButton="True" HeaderText="________ ________"/>
										</Columns>
                        <FooterStyle BackColor="White" ForeColor="#333333" />
                        <HeaderStyle BackColor="#a484b8" Font-Bold="True" ForeColor="White" />
                        <PagerStyle BackColor="#a484b8" ForeColor="White" HorizontalAlign="Center" />
                        <RowStyle BackColor="#e3dae8" ForeColor="#333333" />
    ...
    <div data-content="tabdocuments" class='tab-content'>
        <div id="divDocuments" class="divDocuments" runat="server" visible="false">
			...
			<asp:GridView ID="gvRequestsFiles" runat="server" HeaderStyle-BackColor="#014783" HeaderStyle-ForeColor="White"
         ...
         <%--***********************************--%>
               ...
               <%--     <asp:GridView ID="gvRequestsFiles2" runat="server" HeaderStyle-BackColor="#014783" HeaderStyle-ForeColor="White"
				AlternatingRowStyle-ForeColor="#000" CssClass="gvRequestsFiles" AutoGenerateColumns="false" OnRowCommand="gvRequestsFiles_RowCommand" Visible=false>
				<Columns>
					<asp:BoundField DataField="Name" HeaderText="Имя файла" ControlStyle-Width="100px" ItemStyle-CssClass="grdSearchResultbreakword" />
					<asp:BoundField DataField="FileDescription" HeaderText="Описание" ControlStyle-Width="70px" ItemStyle-CssClass="grdSearchResultbreakword" />
					<asp:TemplateField ItemStyle-HorizontalAlign="Center">
            ...
            <asp:GridView ID="gvRequestsFilesPhoto2" runat="server" AutoGenerateColumns="False" Visible=false>
                <Columns>
					<asp:BoundField DataField="Name" HeaderText="Фото" />
...
<asp:Button ID="btnAgreement" runat="server" Text="Договор" Visible="False" OnClientClick="openNewWin();" class="btn btn-primary" OnClick="btnAgreement_Click"/>
                    ...
                    <asp:Button ID="btnAccount" runat="server" Text="Документы на открытия счета" class="btn btn-primary" OnClick="btnAccount_Click" OnClientClick="openNewWin();"/>
            ...
            <div class="chkbxhead"> <p style="color:green">
                <asp:Label ID="lblNameDcbServ" runat="server" Text="Сервисы"></asp:Label></p></div>
...
<div>
 ...
 <asp:Button ID="btnConfPermSF" runat="server" class="btn btn-primary" Text="Отравить код" OnClick="btnConfPermSF_Click"  />
    ...
    <asp:Button ID="btnBackToCreditForm" runat="server" Text="Назад" class="btn btn-primary" OnClick="btnBackToCreditForm_Click" Visible="false" />
    <br />
     <div>
         <p>
         <span class="fio">ИНН:</span>
		 <asp:TextBox ID="tbSearchINN" runat="server" class="form-control" ClientIDMode="Static"></asp:TextBox>
    ...
    <div>
        <asp:HiddenField ID="hfChooseClient" runat="server" ClientIDMode="Static" />
        ...
        <asp:Panel ID="pnlCustomer" runat="server" Visible="True" CssClass="panels">
...
<div class="row">
       ...
       <asp:UpdatePanel ID="UpdatePanel3" runat="server"><ContentTemplate>
				<asp:TextBox ID="tbIdentificationNumber" ClientIDMode="Static" runat="server" class="form-control" TabIndex="4" OnTextChanged="tbIdentificationNumber_TextChanged" ></asp:TextBox>
        ...
        <div class="col-md-4">
			...
			<div class="row">
                   ...
                   <span class="fio">Пол</span>
                       ...
                       <asp:RadioButtonList ID="rbtSex" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="rbtSex_SelectedIndexChanged">
					<asp:ListItem Selected="True">Мужской</asp:ListItem>
					<asp:ListItem>Женский</asp:ListItem></asp:RadioButtonList>
                       </ContentTemplate></asp:UpdatePanel>
	...
	<asp:Panel ID="pnlSaveCustomer" runat="server">
         <asp:RadioButton ID="rbtnClientType1" runat="server" Text="Клиент" Checked="True" ClientIDMode="Static" GroupName="clientType" />
 <asp:RadioButton ID="rbtnClientType2" runat="server" Text="Поручитель" ClientIDMode="Static" GroupName="clientType" Enabled="False" />
 <asp:RadioButton ID="rbtnClientType3" runat="server" Text="Залогодатель" ClientIDMode="Static" GroupName="clientType" Enabled="False" />
 <br /><br />
		<table>
			<tr>
				<td>&nbsp;</td>
				<td><asp:Button ID="btnSaveCustomer" runat="server" Text="Сохранить" ValidationGroup="SaveCustomers" class="btn btn-primary" OnClick="btnSaveCustomer_Click" ClientIDMode="Static" /></td>
				<td>&nbsp;</td>
...
<script>
    ...
    $(document).ready(function () {
        $("#customer1").click(function () {
            ...
            if (tab == 3) {
                ...
                var li = $('.tabs li');
                var next = $('.tabs li:nth-child(3) a')
            ...
            document.getElementById('hfChooseClient').value = 'Выбрать клиента';
            $('#rbtnClientType1').prop('checked', true);
        });
    ...
    $(document).ready(function () {
        $("#customer2").click(function () {
            ...
            document.getElementById('hfChooseClient').value = 'Выбрать поручителя';
            $('#rbtnClientType2').prop('checked', true);
        });
    ...
    $(document).ready(function () {
        $("#customer3").click(function () {
            ...
            document.getElementById('hfChooseClient').value = 'Выбрать залогодателя';
            $('#rbtnClientType3').prop('checked', true);
        });
...
<script type="text/javascript">
    function pageLoad() {
        ...
        v = document.getElementById("<%= RadNumTbRequestSumm.ClientID %>");
...
<script>
    ...
    <script>
        //$("#tbContactPhone").inputmask({ "mask": "(999) 999-9999" });

        //$(document).ready(function () {
            
        //    $('#tbContactPhone').mask('0000-0000');
        //    $("#tbContactPhone").inputmask({ "mask": "(999) 999-9999" });
        ...
        $(document).ready(function () {
            $("#tbContactPhone").inputmask("+999 999 999999");
            $("#tbIdentificationNumber").inputmask("99999999999999");
            $("#tbSearchINN").inputmask("99999999999999");
            $("#tbDocumentSeries").inputmask("aa9999999");
            $("#tbSerialN").inputmask("aa9999999");
            $('#tbValidTill').inputmask('99.99.9999');
            $('#tbIssueDate').inputmask('99.99.9999');
            $('#tbDateOfBirth').inputmask('99.99.9999');
