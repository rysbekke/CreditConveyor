<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptProfferNano.aspx.cs" Inherits="Zamat.Microcredit.rptProfferNano" %>
...
<table class="line">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblZP" runat="server" Text="Зарплата клиента"></asp:Label>
        </td>
    </tr>
    <tr>
        <td>Доп.доход:</td>
...
<table class="line">
    ...
    <tr>
        <td>Вид кредита:</td>
        <td>Потребительский кредит "Нано"</td>
        <td></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Комиссия за выдачу транша:</td>
        <td>10 процентов от суммы транша</td>
        <td></td>
    </tr>
    <tr>
...
<table class="line">
    ...
    <tr>
        ...
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SystemUser&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblStatus" runat="server" Text="lblStatus"></asp:Label>
            &nbsp; </td>
       <td>
           <asp:Label ID="lblCreditRating" runat="server" Text=""></asp:Label></td>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblDescription" runat="server" Text="lblDescription"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    </tr>
