<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptAgreesToyota.aspx.cs" Inherits="СreditСonveyor.Partners2.rptAgreesToyota" %>
...
<br />
  ...
  <br /><b>2.1.</b> За пользование кредитом Заемщик  ежемесячно уплачивает  Кредитору <b><asp:Label ID="lblRequestRate" runat="server" Text="[Кредит.Ставка]"></asp:Label> &nbsp;(<asp:Label ID="lblRequestRateWord" runat="server" Text="[Кредит.Ставка.Пропись]"></asp:Label>)</b> процент (-а/-ов) годовых  со дня  перечисления суммы кредита на транзитный счет по кредитам, в том числе налог с продаж в размере 2 % от суммы начисленных процентов.
    ...
    <asp:Label ID="lblWithoutCollateral" runat="server" Text="без обеспечения."></asp:Label>
&nbsp;<br />
    <asp:Panel ID="pnlSureties" runat="server">
        <b>3.1.1</b>
    <br />
    ...
    <table class="line">
        ...
        <tr>
            <td>
                <asp:Label ID="lblGuarFIO" runat="server"></asp:Label>
            </td>
            <td>
                <asp:Label ID="lblDocumentSNGuar" runat="server"></asp:Label>
                &nbsp;выдан <asp:Label ID="lblIssueAuthorityGuar" runat="server" Text=""></asp:Label>
                ,&nbsp;от <asp:Label ID="lblIssueDateGuar" runat="server" Text=""></asp:Label>года, согласно договору поручительства № <asp:Label ID="lblCreditNomer5" runat="server" Text=""></asp:Label>&nbsp;от <asp:Label ID="lblAgreementDate5" runat="server" Text=""></asp:Label>
...
<tr><td>
    <asp:Label ID="lblComOpenAcc21" runat="server" Text="Комиссия за открытие и обслуживание счета по кредиту (оплаченная в банке)"></asp:Label></td><td>
        <asp:Label ID="lblComOpenAcc22" runat="server" Text="Отсутствует"></asp:Label></td></tr><tr><td>Комиссия за открытие и обслуживание счета по кредитному траншу</td><td>Отсутствует</td></tr>
<tr><td>Комиссия за расчетно-кассовое обслуживание по кредиту</td><td>Отсутствует</td>
</tr>
...
<tr>
    <td colspan="2">
        <br />На основании Договора о сотрудничестве, данным уведомлением ОАО «Капиталбанк» подтверждает одобрение на выдачу банковского займа, с последующим перечислением суммы  банковского займа за товары:
...
-         нарушение Заемщиком любого из условий Договора.
    ...
    <br />
    2.7.  Банк вправе без дополнительного согласия или уведомления Поручителя, в случае наступления оснований, предусмотренных пунктом 2.3. настоящего договора, в безакцептном порядке удержать сумму задолженности Заемщика перед Банком с любого счета Поручителя, открытого в ОАО «КапиталБанк».
    <br />
...
<table class="rekvisity">
    ...
    <tr>
        ...
        <td>(м.п.)	_________________<br /><asp:Label ID="lblCustomerFIO14" runat="server" Text="[Клиент.ФИО]"></asp:Label></td>
        <td>(м.п.)	_________________<br /><asp:Label ID="lblGuaranterFIO3" runat="server" Text="[Поручитель.ФИО]"></asp:Label></td>
    </tr>
</table>
<br />
        ...
        <br />
       <%-- <asp:Image ID="imgBarCodeProduct" runat="server" />--%>
        <br />
