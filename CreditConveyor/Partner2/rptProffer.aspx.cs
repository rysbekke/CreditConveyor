...
namespace СreditСonveyor.Partners2
{
    public partial class rptProffer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lblAverageMonthSalary.Text = request.AverageMonthSalary.ToString();
            lblAverageMonthSalary2.Text = (request.AverageMonthSalary + request.AdditionalIncome).ToString();
            ...
            lblTotalСonsumption.Text = request.FamilyExpenses.ToString();
            ...
            if ((request.OrgID != 36) && (request.OrgID != 8))
            {
            ...
            if (request.OrgID == 36)
            {
                lblAct.Text = "Приобретаемый товар / услуга";
            }
            else
            {
                lblAct.Text = "Акт оценки залогового имущества";
            }
                /**/
            ...
            //    chp = valp - Convert.ToDouble(RadNumTbOverhead) - Convert.ToDouble(RadNumTbFamilyExpenses) + additionalIncome;
            //    if (chp > 0)
            //    {
            //        cho = chp - k;
            //        y1 = 100 * cho / chp;
