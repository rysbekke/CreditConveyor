...
{
    public partial class rptAgreesToyota : System.Web.UI.Page
    {
        string WorkType;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (req.RequestSumm > 100000)
            {
                lblWithoutCollateral.Visible = false;
                pnlSureties.Visible = true;
            }
            else
            {
                lblWithoutCollateral.Visible = true;
                pnlSureties.Visible = false;
            }
