...
namespace СreditСonveyor.Partners2
{
    public partial class rptProfferAgro : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lblRevenueMilk.Text = Math.Round((RevenueMilk * 30), 0).ToString();
            lblRevenueMilkProd.Text = Math.Round((RevenueMilkProd * 30), 0).ToString();
            ...
            if (requests.RequestSumm > 99999) NameOfCredit = "Потребительский";
            if ((requests.OrgID != 36) && (requests.OrgID != 8))
            {
                if ((requests.RequestRate == 0) && (requests.RequestPeriod == 3)) { commision = 300; NameOfCredit = "0-0-3"; }
                if ((requests.RequestRate == 0) && (requests.RequestPeriod == 6)) { commision = 300; NameOfCredit = "0-0-6"; }
                if ((requests.RequestRate == 0) && (requests.RequestPeriod == 9)) { commision = 300; NameOfCredit = "0-0-9"; }
                if ((requests.RequestRate == 0) && (requests.RequestPeriod == 10)) { commision = 300; NameOfCredit = "10-10-10"; }
                if ((requests.RequestRate == 0) && (requests.RequestPeriod == 12)) { commision = 300; NameOfCredit = "0-0-12"; }
                if ((requests.RequestRate == 0) && (requests.RequestPeriod == 15)) { commision = 0; NameOfCredit = "0-0-15"; }
                if ((requests.RequestRate == 0) && (requests.RequestPeriod == 26)) { commision = 300; NameOfCredit = "0-0-26"; }
                if ((requests.RequestRate == 0) && (requests.RequestPeriod == 27)) { commision = 300; NameOfCredit = "0-0-27"; }
            }

            if (requests.IsEmployer == true) commision = 0;
            if (requests.GroupID == 51) commision = 0;
            ...
            if (requests.OrgID == 27)
            {
                ...
                if ((requests.RequestRate == 0) && (requests.RequestPeriod == 3)) { commision = 3; NameOfCredit = "0-0-3"; }
                if ((requests.RequestRate == 0) && (requests.RequestPeriod == 6)) { commision = 3; NameOfCredit = "0-0-6"; }
                if ((requests.RequestRate == 0) && (requests.RequestPeriod == 12)) { commision = 2; NameOfCredit = "0-0-12"; }
                lblComission.Text = commision.ToString();
