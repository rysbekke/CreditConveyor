<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptAgreesInst.aspx.cs" Inherits="СreditСonveyor.Partners2.rptAgreesInst" %>
...
<tr>
    ...
    <br /><br />Адрес торговой точки <%--<asp:Label ID="lblNameAgencyPointAddress2_2" runat="server" Text=""></asp:Label>--%>
        ____________________________<br />
    <a href="../Card/rptForPeriodWithHistory.aspx">../Card/rptForPeriodWithHistory.aspx</a>
</td>
<tr>
    <td colspan="2">
        <center><b>
