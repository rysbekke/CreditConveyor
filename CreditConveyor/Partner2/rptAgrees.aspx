<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptAgrees.aspx.cs" Inherits="СreditСonveyor.Partners2.rptAgrees" %>
...
<tr><td>Комиссия за открытие и обслуживание счета по кредиту/банковской гарантии</td><td><asp:Label ID="lblComOpenAcc12" runat="server" Text="150,00 (Сто пятьдесят сом, 00 тыйын)"></asp:Label></td></tr>
