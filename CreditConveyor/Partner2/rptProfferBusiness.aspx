<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptProfferBusiness.aspx.cs" Inherits="СreditСonveyor.Partners2.rptProfferBusiness" %>
...
<table class="line">
   <tr>
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblCommisionType" runat="server" Text=""></asp:Label>
        </td>
    </tr>
</table>
