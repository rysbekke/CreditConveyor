...
namespace СreditСonveyor.Data.Technodom
{
    public class CreditController
    {
        ...
        public HistoriesCustomer HistoriesCustomerGetItem(int CreditID)
        {
            ...
            item = (from v in dbW.HistoriesCustomers where v.CreditID == CreditID select v).FirstOrDefault();
            return item;
        }
        ...
        public IncomesStructure GetIncomesStructureByCreditID(int itemid)
        {
            ...
            //dbdataDataContext db = new dbdataDataContext(connectionString);
            dbdataDataContext dbW = new dbdataDataContext(connectionStringW);
            itm = dbW.IncomesStructures.Where(g => g.CreditID == itemid).FirstOrDefault();
            return itm;
        }
        ...
        /*****************************************************************/
        public void ItemRequestHistoriesAddItem(RequestsHistory newItem)
        {
            //dbdataDataContext db = new dbdataDataContext(connectionString);
        ...
        public void ItemHistoriesStatuseAddItem(HistoriesStatuse newItem)
        {
            //dbdataDataContext db = new dbdataDataContext(connectionString);
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringRWZ);
            dbRWZ.HistoriesStatuses.InsertOnSubmit(newItem);
            dbRWZ.HistoriesStatuses.Context.SubmitChanges();
        }
