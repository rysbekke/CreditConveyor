...
namespace СreditСonveyor.Data.Nurtelecom
{
    public class CreditController
    {
        ...
        //dataDataContext dbW = new dbdataDataContext(connectionStringW);
        ...
        public History GetHistoryByCreditID(int itemid)
        {
            ...
            //dbdataDataContext db = new dbdataDataContext(connectionString);
            dbdataDataContext dbW = new dbdataDataContext(connectionStringW);
            itm = dbW.Histories.Where(g => g.CreditID == itemid).FirstOrDefault();
            return itm;
        }
        ...
        public IncomesStructuresActualDate GetIncomesStructuresActualDateByCreditID(int itemid)
        {
            ...
            //dbdataDataContext db = new dbdataDataContext(connectionString);
            dbdataDataContext dbW = new dbdataDataContext(connectionStringW);
            itm = dbW.IncomesStructuresActualDates.Where(g => g.CreditID == itemid).FirstOrDefault();
            return itm;
        }
