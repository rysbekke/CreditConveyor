...
namespace СreditСonveyor.Data.BeelineS
{
    ...
    public class ItemController
    {
        ...
        public static List<Requests2> GetRequestsForAgent(int userID, int? agentRoleID, string nRequest, string inn, string creditID, string surname, string name, string date1, string date2, string connectionString, int? groupID, bool i0, bool i1, bool i2, bool i3, bool i4, bool i5, bool i6, bool i7, bool i8, bool i9, bool i10, bool i11, bool i12, bool k0, bool k1, bool k2, bool g1, bool g2, int pageIndex, int pageSize, bool o0, bool o1, bool o2, bool o3, bool o4, bool o5, bool o6, bool o7, bool o8, bool o9)
        {
            ...
            List<Requests2> lst0 = new List<Requests2>();
            if ((nRequest != "") || (inn != "") || (creditID != "") || (surname != "") || (name != ""))
            {
                if (inn != "") lst0 = (from v in dbRWZ.Requests2s where (v.IdentificationNumber == inn) select v).ToList();
                if (nRequest != "") lst0 = (from v in dbRWZ.Requests2s where (v.RequestID == Convert.ToInt32(nRequest)) select v).ToList();
                if (surname != "") lst0 = (from v in dbRWZ.Requests2s where (v.Surname == surname) select v).ToList();
                if (name != "") lst0 = (from v in dbRWZ.Requests2s where (v.CustomerName == name) select v).ToList();
                if (inn != "") lst0 = (from v in dbRWZ.Requests2s where (v.IdentificationNumber == inn) select v).ToList();
                if (creditID != "") lst0 = (from v in dbRWZ.Requests2s where (v.CreditID == Convert.ToInt32(creditID)) select v).ToList();

            }
            else lst0 = (from v in dbRWZ.Requests2s where ((v.RequestDate.Value.Date == DateTime.ParseExact(date1, "yyyy.MM.dd", CultureInfo.InvariantCulture)) || (v.RequestDate.Value.Date > DateTime.ParseExact(date1, "yyyy.MM.dd", CultureInfo.InvariantCulture)) && (v.RequestDate.Value.Date < DateTime.ParseExact(date2, "yyyy.MM.dd", CultureInfo.InvariantCulture)) || (v.RequestDate.Value.Date == DateTime.ParseExact(date2, "yyyy.MM.dd", CultureInfo.InvariantCulture))) select v).ToList();
            ...
            //var lst0 = ((nRequest != "") || (inn != "") || (creditID != "") || (surname != "") || (name != "")) ? (from v in dbRWZ.Requests2s select v).ToList() : (from v in dbRWZ.Requests2s where ((v.RequestDate.Value.Date == DateTime.ParseExact(date1, "yyyy.MM.dd", CultureInfo.InvariantCulture)) || (v.RequestDate.Value.Date > DateTime.ParseExact(date1, "yyyy.MM.dd", CultureInfo.InvariantCulture)) && (v.RequestDate.Value.Date < DateTime.ParseExact(date2, "yyyy.MM.dd", CultureInfo.InvariantCulture)) || (v.RequestDate.Value.Date == DateTime.ParseExact(date2, "yyyy.MM.dd", CultureInfo.InvariantCulture))) select v).ToList();
                            ...
                            if ((ech.RequestStatus != "Выдано") && (ech.RequestStatus != "На выдаче") && (ech.RequestStatus != "Отменено") && (ech.RequestStatus != "Отказано") && (ech.RequestStatus != "Принято"))
                            {
                                ...
                                if (historystatus.Count > 0)
                                {
                                    ...
                                    if ((f == 3) || (f == 5))
                                    {
                                        ...
                                        /*RequestHistory*/
                                        RequestsHistories2 newItem = new RequestsHistories2()
                                        {
        ...
        public static List<Requests2> GetRequestsAllForAdmin(int userID, int? agentRoleID, int? orgID, string nRequest, string inn, string creditID, string surname, string name, string date1, string date2, string connectionString, bool i0, bool i1, bool i2, bool i3, bool i4, bool i5, bool i6, bool i7, bool i8, bool i9, bool i10, bool i11, bool i12, bool k0, bool k1, bool k2, bool g1, bool g2, int pageIndex, int pageSize, bool o0, bool o1, bool o2, bool o3, bool o4, bool o5, bool o6, bool o7, bool o8, bool o9)
        {
            dbdataDataContext dbR = new dbdataDataContext(connectionStringR);
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringZ);
        ...
        public static List<Requests2> GetRequestsAllForExpert(int userID, int? agentRoleID, string nRequest, string inn, string creditID, string surname, string name, string date1, string date2, string connectionString, bool i0, bool i1, bool i2, bool i3, bool i4, bool i5, bool i6, bool i7, bool i8, bool i9, bool i10, bool i11, bool i12, bool k0, bool k1, bool k2, bool g1, bool g2, int pageIndex, int pageSize, bool o0, bool o1, bool o2, bool o3, bool o4, bool o5, bool o6, bool o7, bool o8, bool o9)
        {
        ...
        public static List<Requests2> GetRequestsForExpert(int userID, int? agentRoleID, string nRequest, string inn, string creditID, string surname, string name, string date1, string date2, string connectionString, bool i0, bool i1, bool i2, bool i3, bool i4, bool i5, bool i6, bool i7, bool i8, bool i9, bool i10, bool i11, bool i12, bool k0, bool k1, bool k2, bool g1, bool g2, int pageIndex, int pageSize, bool o0, bool o1, bool o2, bool o3, bool o4, bool o5, bool o6, bool o7, bool o8, bool o9)
        {
            dbdataDataContext dbR = new dbdataDataContext(connectionStringR);
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringZ);
            int branchID = 5;
        ...
        public void RequestFilesAddItem(RequestsFile newItem)
        {
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringZ);
        ...
        public int ItemRequestAddItem2(Request newItem)
        {
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringZ);
        ...
        public void RequestProductAddItem(RequestsProduct newItem)
        {
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringZ);
        ...
        public void ItemRequestFilesAddItem(RequestsFiles2 newItem)
        {
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringZ);
            dbRWZ.RequestsFiles2s.InsertOnSubmit(newItem);
            dbRWZ.RequestsFiles2s.Context.SubmitChanges();
        }
        ...
        public Requests2 GetRequestByCreditID(int itemid)
        {
            Requests2 itm = new Requests2();
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringZ);
            itm = dbRWZ.Requests2s.Where(g => g.CreditID == itemid).FirstOrDefault();
            return itm;
        }
        //public Requests2 GetRequestByRequestID(int itemid)
        //{
        //    Requests2 itm = new Requests2();
        //    dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringZ);
        //    itm = dbRWZ.Requests2s.Where(g => g.CreditID == itemid).FirstOrDefault();
        ...
        public Requests2 GetRequestByRequestID(int reqid)
        {
            Requests2 itm = new Requests2();
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringZ);
            itm = dbRWZ.Requests2s.Where(g => g.RequestID == reqid).FirstOrDefault();
            return itm;
        }


        public void RequestUpd(Requests2 item)
        {
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringZ);
            var lst = dbRWZ.Requests2s.Where(r => r.RequestID == item.RequestID).FirstOrDefault();
            ...
            dbRWZ.Requests2s.Context.SubmitChanges();
        }
