...
namespace СreditСonveyor.Data.Partners2
{
    public class ItemController
    {
        ...
        public static List<Request> GetRequestsForAgent(int userID, int? agentRoleID, string nRequest, string inn, string creditID, string surname, string name, string date1, string date2, string connectionString, bool i0, bool i1, bool i2, bool i3, bool i4, bool i5, bool i6, bool i7, bool i8, bool i9, bool i10, bool i11, bool i12, bool k0, bool k1, bool k2, bool g1, bool g2, bool g3, int pageIndex, int pageSize, bool o0, bool o1, bool o2, bool o3, bool o4, bool o5, bool o6, bool o7, bool o8, bool o9)
        {
            ...
            var lst18 = (i11 == false) ? (from v in lst17 where (v.RequestStatus != "К подписи") select v).ToList() : lst17;
            ...
            var lst22 = (g1 == false) ? (from v in lst21 where (v.GroupID != 128) select v).ToList() : lst21;  //дкб
            var lst23 = (g2 == false) ? (from v in lst22 where ((v.GroupID == 128) || (v.GroupID == 134)) select v).ToList() : lst22;  //кроме dcb
            var lst24 = (g3 == false) ? (from v in lst23 where (v.GroupID != 134) select v).ToList() : lst23;  //cola
                ...
                foreach (var ech in lst35)
                {
                    ...
                    if ((ech.StatusOB != "Выдан") && (ech.StatusOB != "Отказано"))
                    {
                        ...
                        if ((ech.RequestStatus != "Выдано") && (ech.RequestStatus != "На выдаче") && (ech.RequestStatus != "Отменено") && (ech.RequestStatus != "Отказано") && (ech.RequestStatus != "Принято"))
                        {
                            ...
                            //foreach (var hstat in historystatus2)
                            if (historystatus.Count > 0)
                            {
                                var hstat = historystatus.Last();
                                ...
                                var usrs2 = dbRWZ.Users2s.Where(u => u.UserIDOB == hstat.UserID).ToList().FirstOrDefault(); //скоринг
                                {
                                    ...
                                    if (hstat.StatusID == 0) { f = 0; }
                                    if (hstat.StatusID == 1) { f = 1; }
                                    if (hstat.StatusID == 2) { f = 2; }
                                    if (hstat.StatusID == 3) { f = 3; }
                                    if (hstat.StatusID == 4) { f = 4; }
                                    if (hstat.StatusID == 5) { f = 5; }
                                    if (hstat.StatusID == 6) { f = 6; }
                                    if (hstat.StatusID == 7) { f = 7; }
                                    if (hstat.StatusID == 8) { f = 8; }
                                    if (hstat.StatusID == 9) { f = 9; }
                                }
                                if (f == 3)
                                {
                                    ...
                                    var reqs = dbRWZ.Requests.Where(r => r.RequestID == ech.RequestID).FirstOrDefault();
                                    if ((reqs.RequestStatus == "К подписи") || (reqs.GroupID == 128))
                                    {
        ...
        public static List<Request> GetRequestsAllForAdmin(int userID, int? agentRoleID, int? orgID, string nRequest, string inn, string creditID, string surname, string name, string date1, string date2, string connectionString, bool i0, bool i1, bool i2, bool i3, bool i4, bool i5, bool i6, bool i7, bool i8, bool i9, bool i10, bool i11, bool i12, bool k0, bool k1, bool k2, bool g1, bool g2, bool g3, int pageIndex, int pageSize, bool o0, bool o1, bool o2, bool o3, bool o4, bool o5, bool o6, bool o7, bool o8, bool o9)
        {
            ...
            lst0 = (from v in lst0 where ((v.AgentRoleID == agentRoleID) && (v.OrgID == orgID)) select v).ToList();
            ...
            var lst22 = (g1 == false) ? (from v in lst21 where (v.GroupID != 128) select v).ToList() : lst21;  //осторе
            var lst23 = (g2 == false) ? (from v in lst22 where ((v.GroupID == 128) || (v.GroupID == 134)) select v).ToList() : lst22;  //Нуртелеком
            var lst24 = (g3 == false) ? (from v in lst23 where (v.GroupID != 134) select v).ToList() : lst23;  //Нуртелеком //var lst24 = (g3 == false) ? (from v in lst23 where (v.GroupID != 91) select v).ToList() : lst23; //нано
        ...
        public static List<Request> GetRequestsAllForExpert(int userID, int? agentRoleID, string nRequest, string inn, string creditID, string surname, string name, string date1, string date2, string connectionString, bool i0, bool i1, bool i2, bool i3, bool i4, bool i5, bool i6, bool i7, bool i8, bool i9, bool i10, bool i11, bool i12, bool k0, bool k1, bool k2, bool g1, bool g2, bool g3, int pageIndex, int pageSize, bool o0, bool o1, bool o2, bool o3, bool o4, bool o5, bool o6, bool o7, bool o8, bool o9)
        {
            ...
            var lst22 = (g1 == false) ? (from v in lst21 where (v.GroupID != 128) select v).ToList() : lst21;  //dcb.kg
            var lst23 = (g2 == false) ? (from v in lst22 where ((v.GroupID == 128) || (v.GroupID == 134)) select v).ToList() : lst22;  //кроме dcb
            var lst24 = (g3 == false) ? (from v in lst23 where (v.GroupID != 134) select v).ToList() : lst23;  //cola
                            ...
                            if (historystatus.Count > 0)
                            {
                                ...
                                if (f == 3)
                                {
                                    ...
                                    if (ech.GroupID != 134)
                                    {
                                        ...
                                        try
                                        {
                                            //resp = await SendStatusDCB360(ech.CreditID.ToString(), "APPROVED");
        ...
        //public async System.Threading.Tasks.Task<string> sndStatusDCB360Async(string CreditID)
        //{
        //    respDCB360 resp = null;
        //    resp = await SendStatusDCB360(CreditID, "APPROVED");
        ...
        public static List<Request> GetRequestsForExpert(int userID, int? agentRoleID, string nRequest, string inn, string creditID, string surname, string name, string date1, string date2, string connectionString, bool i0, bool i1, bool i2, bool i3, bool i4, bool i5, bool i6, bool i7, bool i8, bool i9, bool i10, bool i11, bool i12, bool k0, bool k1, bool k2, bool g1, bool g2, bool g3, int pageIndex, int pageSize, bool o0, bool o1, bool o2, bool o3, bool o4, bool o5, bool o6, bool o7, bool o8, bool o9)
        {
            ...
            var lst22 = (g1 == false) ? (from v in lst21 where (v.GroupID != 128) select v).ToList() : lst21;  //осторе
            var lst23 = (g2 == false) ? (from v in lst22 where ((v.GroupID == 128) || (v.GroupID == 134)) select v).ToList() : lst22;  //Нуртелеком 
            //var lst23 = (g2 == false) ? (from v in lst22 where (v.GroupID != 128) select v).ToList() : lst22;  //Нуртелеком 
            var lst24 = (g3 == false) ? (from v in lst23 where (v.GroupID != 134) select v).ToList() : lst23; //cola
        ...
        public static List<Request> GetRequestsForExpertBusiness(int userID, int? agentRoleID, string nRequest, string inn, string creditID, string surname, string name, string date1, string date2, string connectionString, bool i0, bool i1, bool i2, bool i3, bool i4, bool i5, bool i6, bool i7, bool i8, bool i9, bool i10, bool i11, bool i12, bool k0, bool k1, bool k2, bool g1, bool g2, bool g3, int pageIndex, int pageSize, bool o0, bool o1, bool o2, bool o3, bool o4, bool o5, bool o6, bool o7, bool o8, bool o9)
        {
            dbdataDataContext dbR = new dbdataDataContext(connectionStringR);
            dbdataDataContext dbW = new dbdataDataContext(connectionStringW);
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringRWZ);
            ...
            //var lst0 = ((nRequest != "") || (inn != "") || (creditID != "") || (surname != "") || (name != "")) ? (from v in dbRWZ.Requests select v).ToList() : (from v in dbRWZ.Requests where ((v.RequestDate.Value.Date == DateTime.ParseExact(date1, "yyyy.MM.dd", CultureInfo.InvariantCulture)) || (v.RequestDate.Value.Date > DateTime.ParseExact(date1, "yyyy.MM.dd", CultureInfo.InvariantCulture)) && (v.RequestDate.Value.Date < DateTime.ParseExact(date2, "yyyy.MM.dd", CultureInfo.InvariantCulture)) || (v.RequestDate.Value.Date == DateTime.ParseExact(date2, "yyyy.MM.dd", CultureInfo.InvariantCulture))) select v).ToList();
            //var lst1 = (inn == "") ? (from v in lst0 where ((v.AgentRoleID == agentRoleID) && (v.BranchID == branchID)) select v).ToList() : (from v in lst0 where ((v.IdentificationNumber == inn) && (v.AgentRoleID == agentRoleID) && (v.BranchID == branchID)) select v).ToList();
            //var lst1_2 = (from v in lst1 where (v.GroupID == 134) select v).ToList();
            ...
            var lst22 = (g1 == false) ? (from v in lst21 where (v.GroupID != 128) select v).ToList() : lst21;  //осторе
            var lst23 = (g2 == false) ? (from v in lst22 where ((v.GroupID == 128) || (v.GroupID == 134)) select v).ToList() : lst22;  //Нуртелеком
            var lst24 = (g3 == false) ? (from v in lst23 where (v.GroupID != 134) select v).ToList() : lst23; //нано
        ...
        public static List<Request> GetRequestsAllForExpert(int userID, int? agentRoleID, string inn, string surname, string name, string date1, string date2, string connectionString)
        {
            dbdataDataContext dbR = new dbdataDataContext(connectionStringR);
            dbdataDataContext dbW = new dbdataDataContext(connectionStringW);
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringRWZ);
                ...
                foreach (var ech in lst4)
                {
                    ...
                    if ((ech.RequestStatus != "Выдано") && (ech.RequestStatus != "На выдаче") && (ech.RequestStatus != "Отменено") && (ech.RequestStatus != "Отказано") && (ech.RequestStatus != "Принято"))
                    {
                        ...
                        if (historystatus.Count > 0)
                        {
                            ...
                            var usrs2 = dbR.Users2s.Where(u => u.UserName == usrs.UserName).ToList().FirstOrDefault();
                            {
                                if (hstat.StatusID == 0) { f = 0; }
                                if (hstat.StatusID == 1) { f = 1; }
                                if (hstat.StatusID == 2) { f = 2; }
        ...
        {
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringRWZ);
            var lst = dbRWZ.Requests.Where(r => r.RequestID == item.RequestID).FirstOrDefault();
            ...
            lst.IsReceivedMPZ = item.IsReceivedMPZ;
            lst.CardAccount = item.CardAccount;
        ...
        public void ItemJournalDCBKGAdd(JournalCardCreditDCBKG newItem)
        {
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringRWZ);
            dbRWZ.JournalCardCreditDCBKG.InsertOnSubmit(newItem);
            dbRWZ.JournalCardCreditDCBKG.Context.SubmitChanges();
        }

        public void ItemJournalDCBKGUpd(JournalCardCreditDCBKG item)
        {
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringRWZ);
            var itm = dbRWZ.JournalCardCreditDCBKG.Where(r => r.ID == item.ID).FirstOrDefault();
            itm.Status = item.Status;
            dbRWZ.JournalCardCreditDCBKG.Context.SubmitChanges();
        }

        public void ItemJournalDCBColaAdd(JournalDCBCola newItem)
        {
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringRWZ);
            dbRWZ.JournalDCBColas.InsertOnSubmit(newItem);
            dbRWZ.JournalDCBColas.Context.SubmitChanges();
        }

        public void ItemJournalDCBColaUpd(JournalDCBCola item)
        {
            dbdataDataContext dbRWZ = new dbdataDataContext(connectionStringRWZ);
            var itm = dbRWZ.JournalDCBColas.Where(r => r.ID == item.ID).FirstOrDefault();
            itm.Status = item.Status;
            dbRWZ.JournalDCBColas.Context.SubmitChanges();
        }
    }
