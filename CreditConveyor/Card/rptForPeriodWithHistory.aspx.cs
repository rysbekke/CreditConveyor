...
namespace СreditСonveyor.Card
{
    public partial class rptForPeriodWithHistory : System.Web.UI.Page
    {
        ...
        public void refreshGrid()
        {
            ...
            if (rle == 2) { lst = ItemController.GetRequestsForExpert(usrID, agentRoleID, nRequestID, inn, surname, name, dt1, dt2, connectionStringR, i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, 0, 10000); } //Эксперты филиала
            else if (rle == 9) { lst = ItemController.GetRequestsAllForAdmin(usrID, agentRoleID, nRequestID, orgID, inn, surname, name, dt1, dt2, connectionStringR, i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, 0, 10000); } //Админы O!
            ...
            if (lst.Count > 0)
            {
                ...
                var lst6 = (from r in lst5
                            join h in dbRWZ.CardRequestsHistories on r.CreditID equals h.CreditID
                            select new
                            {
                                r.CreditID,
                                r.RequestID,
        ...
        protected void btnExpToExcel_Click(object sender, EventArgs e)
        {
            ...
            ExportGrid(DGridHist, "ExportToExcelWithHistory.xls");
        }
