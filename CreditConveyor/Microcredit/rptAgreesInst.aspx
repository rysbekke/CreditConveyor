<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptAgreesInst.aspx.cs" Inherits="СreditСonveyor.Microcredit.rptAgreesInst" %>
...
<tr><td>Номинальная процентная ставка</td><td><asp:Label ID="lblRequestRate5" runat="server" Text="[Кредит.Ставка]"></asp:Label>%</td></tr>
<tr><td>Комиссия за открытие и обслуживание счета по кредиту (оплаченная через партнера)</td><td><asp:Label ID="lblComisiionForOpenCount" runat="server" Text="300,00 (Триста сом, 00 тыйын)"></asp:Label></td></tr>
<tr><td>Комиссия за открытие и обслуживание счета по кредиту (оплаченная в банке)</td><td>Отсутствует</td></tr>
...
<tr><td colspan="2" class="centre"><b>Штрафные санкции и пени банка</b></td></tr>
<tr><td>За просрочку оплаты платежей по основной сумме долга (в день)</td><td>30%/360</td></tr>
...
<br /><br />
            ...
            <table>
                <tr>
                    <td>
                        <asp:Label ID="lblManagerFIO6" runat="server" Text="[Система.Пользователь]"></asp:Label>
                    </td>
                    <td>/____________/</td>
                    <td>
                        <asp:Label ID="lblAgreementDate8" runat="server" Text="[Кредит.ДатаВыдачи]"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    <td>Заемщик:
                        <asp:Label ID="lblCustomerFIO11" runat="server" Text="[Клиент.ФИО]"></asp:Label>
                    </td>
                    <td>/____________/</td>
                    <td>
                        <asp:Label ID="lblAgreementDate9" runat="server" Text="[Кредит.ДатаВыдачи]"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td></td>
