...
{
    public partial class Microcredit : System.Web.UI.Page
    {
        ...
        public void refreshGrid()
        {
            ...
            List<Request> lst;
            if (rle == 5) { lst = ItemController.GetRequestsAllForExpert(usrID, agentRoleID, nRequest, inn, creditID, surname, name, dt1, dt2, connectionStringR, chkbxlistStatus.Items[0].Selected, chkbxlistStatus.Items[1].Selected, chkbxlistStatus.Items[2].Selected, chkbxlistStatus.Items[3].Selected, chkbxlistStatus.Items[4].Selected, chkbxlistStatus.Items[5].Selected, chkbxlistStatus.Items[6].Selected, chkbxlistStatus.Items[7].Selected, chkbxlistStatus.Items[8].Selected, chkbxlistStatus.Items[9].Selected, chkbxlistStatus.Items[10].Selected, chkbxlistStatus.Items[11].Selected, chkbxlistStatus.Items[12].Selected, chkbxlistKindActivity.Items[0].Selected, chkbxlistKindActivity.Items[1].Selected, chkbxlistKindActivity.Items[2].Selected, chkbxGroup.Items[0].Selected, chkbxGroup.Items[1].Selected, gvRequests.PageIndex, gvRequests.PageSize, chkbxOffice.Items[0].Selected, chkbxOffice.Items[1].Selected, chkbxOffice.Items[2].Selected, chkbxOffice.Items[3].Selected, chkbxOffice.Items[4].Selected, chkbxOffice.Items[5].Selected, chkbxOffice.Items[6].Selected, chkbxOffice.Items[7].Selected, chkbxOffice.Items[8].Selected, chkbxOffice.Items[9].Selected); } //Эсперты ГБ Капитал
            else if (rle == 2) { lst = ItemController.GetRequestsForExpert(usrID, agentRoleID, nRequest, inn, creditID, surname, name, dt1, dt2, connectionStringR, chkbxlistStatus.Items[0].Selected, chkbxlistStatus.Items[1].Selected, chkbxlistStatus.Items[2].Selected, chkbxlistStatus.Items[3].Selected, chkbxlistStatus.Items[4].Selected, chkbxlistStatus.Items[5].Selected, chkbxlistStatus.Items[6].Selected, chkbxlistStatus.Items[7].Selected, chkbxlistStatus.Items[8].Selected, chkbxlistStatus.Items[9].Selected, chkbxlistStatus.Items[10].Selected, chkbxlistStatus.Items[11].Selected, chkbxlistStatus.Items[12].Selected, chkbxlistKindActivity.Items[0].Selected, chkbxlistKindActivity.Items[1].Selected, chkbxlistKindActivity.Items[2].Selected, chkbxGroup.Items[0].Selected, chkbxGroup.Items[1].Selected, gvRequests.PageIndex, gvRequests.PageSize, chkbxOffice.Items[0].Selected, chkbxOffice.Items[1].Selected, chkbxOffice.Items[2].Selected, chkbxOffice.Items[3].Selected, chkbxOffice.Items[4].Selected, chkbxOffice.Items[5].Selected, chkbxOffice.Items[6].Selected, chkbxOffice.Items[7].Selected, chkbxOffice.Items[8].Selected, chkbxOffice.Items[9].Selected); } //Эксперты филиала Капитал
